...
echo "There has been a Colab script code change that MAY REQUIRE an update how we install RAPIDS into Colab!  "
echo "That update is below.  Please STOP cell execution and CUT and PASTE this script into the cell you just ran and rerun it."
echo " "
